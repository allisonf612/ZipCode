...
<div class="fieldcontain ${hasErrors(bean: countryInstance, field: 'stateNames', 'error')} required">
	<label for="stateNames">
		<g:message code="country.stateNames.label" default="State Names" />
